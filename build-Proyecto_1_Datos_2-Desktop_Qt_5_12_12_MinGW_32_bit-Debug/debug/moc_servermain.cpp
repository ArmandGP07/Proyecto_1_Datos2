...
#include "../../Proyecto_1_Datos_2/servermain.h"
...
void ServerMain::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ServerMain *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject ServerMain::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_ServerMain.data,
    qt_meta_data_ServerMain,
    qt_static_metacall,
    nullptr,
    nullptr
} };
